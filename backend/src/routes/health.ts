  ...
  fastify.get(
    '/health',
    {
      schema: {
        ...
        description: 'Returns 200 OK if the HTTP server process is running and responsive.',
      },
    },
    async (request, reply) => {
  ...
  fastify.get(
    '/ready',
    {
      schema: {
        ...
        description:
          'Verifies PostgreSQL database and Redis health and returns operational status.',
      },
    },
    async (request, reply) => {
